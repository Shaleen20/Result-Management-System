...
<center><strong>COMPUTER TRAINING INSTITUTE</strong></center>
...
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>Institution Name: Computer Training Institute</th>
          <th>Batch: <%=rs.getString(1) %></th>
          <th>Batch Time: <%=rs.getString(2) %></th>
...
<body>
  <table>
    ...
    <tbody>
      <tr>
        <td>NAS101</td>
        <td colspan="2">Java Programmimg</td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>NAS102</td>
        <td colspan="2">Database System</td>
        <td>Theory</td>
        <td>100</td>
        <td>30</td>
      ...
      <tr>
        <td>NAS151</td>
        <td colspan="2">Machine Learing</td>
        <td>Theory</td>
        <td>100</td>
        <td>30</td>
